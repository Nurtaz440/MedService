package mening.dasturim.medservice.ui.main.user.nevralogiya
...
class Nerv : BaseFragment<FragmentLorBinding, NervVM>() {
    ...
    override fun getLayoutResId()=R.layout.fragment_nerv

    override val vm: NervVM
        get() = ViewModelProvider(this).get(NervVM::class.java)
